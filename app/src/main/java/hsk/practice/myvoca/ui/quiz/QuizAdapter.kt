...
import hsk.practice.myvoca.ui.seeall.recyclerview.VocabularyImplDiffCallback

class QuizAdapter(private val onClick: (position: Int) -> Unit) :
    ListAdapter<VocabularyImpl, QuizAdapter.QuizViewHolder>(VocabularyImplDiffCallback()) {
    ...
    inner class QuizViewHolder(
        ...
        fun bind(quizOption: VocabularyImpl) {
...
fun TextView.bindQuiz(quizOption: VocabularyImpl) {
    val basicText =
